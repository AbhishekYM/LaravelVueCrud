...
function buildProps(node, context, props = node.props, isComponent2, isDynamicComponent, ssr = false) {
  ...
  const analyzePatchFlag = ({ key, value }) => {
    if (isStaticExp(key)) {
      ...
      if (isEventHandler && (!isComponent2 || isDynamicComponent) && name.toLowerCase() !== "onclick" && name !== "onUpdate:modelValue" && !isReservedProp3(name)) {
...
var transformOn = (dir, node, context, augmentor) => {
  ...
  if (arg.type === 4) {
    if (arg.isStatic) {
      ...
      const eventString = node.tagType !== 0 || rawName.startsWith("vnode") || !/[A-Z]/.test(rawName) ? toHandlerKey3(camelize3(rawName)) : `on:${rawName}`;
...
//# sourceMappingURL=chunk-5GSIFUOG.js.map

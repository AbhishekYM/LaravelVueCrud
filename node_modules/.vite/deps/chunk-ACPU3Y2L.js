...
var transformOn = (dir, node, context, augmentor) => {
  ...
  if (arg.type === 4) {
    if (arg.isStatic) {
      ...
      const eventString = node.tagType === 1 || rawName.startsWith("vnode") || !/[A-Z]/.test(rawName) ? toHandlerKey3(camelize3(rawName)) : `on:${rawName}`;
...
//# sourceMappingURL=chunk-ACPU3Y2L.js.map
